...
#Setting up my board as a list,
# where each index 1-9 corresponds with a number on a number pad,
# so I get a 3 by 3 board representation.
    ...
    while game_on:
        if turn=='Player 1':
            ...
            if win_check(theBoard,player1_marker):
                display_board(theBoard)
                print("Congratulations!You have won the game Player 1  :D")
                game_on=False
            else:
            ...
            if win_check(theBoard, player2_marker):
                display_board(theBoard)
                print("Congratulations!You have won the game Player 2  :D")
                game_on = False
            else:
                if full_space_check(theBoard):
                    display_board(theBoard)
